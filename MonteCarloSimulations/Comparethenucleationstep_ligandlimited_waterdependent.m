...
figure
plot(water/2.303,log(nuclearate)/2.303,'b*');
...
xlabel('log (x[H_{2}O])','fontsize',figure_FontSize,'fontname','Arial')
set(gca,'fontsize',figure_FontSize,'fontname','Arial')
[p s] = polyfit((water)'/2.303,log(nuclearate)/2.303,1);
...
legend('boxoff')
set(gca,'Xtick',-2:0.2:-1.5,'Ytick',-2.35:0.02:-2.25);

save(strcat('comparethenucleationstep20190227_waterdenpendent_delta',num2str(delta),'.mat'),'-v7.3');
