...
%    growthrate(k)=crystalsize(k,l)/t;
...
figure
plot(H2BPDC/2.303,log(getgrowthrate)/2.303,'b*');
% errorbar(H2BPDC/2.303,log(getgrowthrate)/2.303,stdgrowthrate/2.303/2,'*')
figure_FontSize = 14;
