...
figure
plot(Hf12_Hf6/2.303,log(nuclearate)/2.303,'b*');
...
set(gca,'xtick',-0.2:0.1:0.2,'ytick',-2.4:0.05:-2.2);

[p s] = polyfit((Hf12_Hf6')/2.303,log(nuclearate)/2.303,1);
...
legend('boxoff')
data2save=[Hf12_Hf6' nuclearate];

save(strcat('comparethenucleationstep20190227_Hf12Hf6denpendent_delta',num2str(delta),'.mat'),'-v7.3');
