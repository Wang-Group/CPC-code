function [ p ] = AssignProbability6copy20181030_Hf6(H2BPDC,formic,formate_formic,water,n_head,n_lateral,delta,addprobability,gama,n1)
...
dGn1 = (n-n1)*(dG1+mixentropy-dST/2+X) + entropy_penalty; %head_penalty is the difference in the enthalpy change of the head sites and the lateral sites  
