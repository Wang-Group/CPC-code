...
save(strcat('comparethenucleationstep20190910_delta',num2str(delta),'.mat'),'-v7.3');    
end
...
figure
figure_FontSize = 14;
plot(nuclearate(select1),expthickness(select1),'*');
xlabel('nucleation rate','fontsize',figure_FontSize,'fontname','Arial')
ylabel('expthickness','fontsize',figure_FontSize,'fontname','Arial')
set(gca,'fontsize',figure_FontSize,'fontname','Arial')

figure
plot(H2BPDC(select1),nuclearate(select1),'*');
ylabel('nucleation rate','fontsize',figure_FontSize,'fontname','Arial')
xlabel('H2BPDC','fontsize',figure_FontSize,'fontname','Arial')
set(gca,'fontsize',figure_FontSize,'fontname','Arial')

figure
plot(formic(select1),nuclearate(select1),'*');
ylabel('nucleation rate','fontsize',figure_FontSize,'fontname','Arial')
xlabel('formic acid','fontsize',figure_FontSize,'fontname','Arial')
set(gca,'fontsize',figure_FontSize,'fontname','Arial')
